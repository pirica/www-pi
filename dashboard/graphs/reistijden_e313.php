...
require_once ('../../_core/components/jpgraph/jpgraph.php');
require_once ('../../_core/components/jpgraph/jpgraph_bar.php');
require_once ('../../_core/components/jpgraph/jpgraph_line.php');
