...
<div class="row">
	...
	<div class="col-xs-12 col-md-6">
		<div class="timings" style="position: relative;">
			...
			<div class="to" style="position: absolute; left: 63%; top: 64%;">	<span><?= $timings['ao-az'] ?></span>	</div>
			<div class="to" style="position: absolute; left: 53%; top: 73%;">	<span><?= $timings['az-ac'] ?></span>	</div>

			<div class="from" style="position: absolute; left: 53%; top: 81%;">	<span><?= $timings['ac-az'] ?></span>	</div>
			<div class="from" style="position: absolute; left: 66%; top: 69%;">	<span><?= $timings['az-ao'] ?></span>	</div>
